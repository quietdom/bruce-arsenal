🌐 [English](../README.md) | [Portugues](README_PT.md) | **Italiano** | [Francais](README_FR.md) | 🇷🇺 [Русский](README_RU.md) | 🇨🇳 [中文](README_ZH.md) | [Polski](README_PL.md) | [Nederlands](README_NL.md) | [Turkce](README_TR.md) | [Deutsch](README_DE.md) | Tiếng Việt [Tiếng Việt](README_VN.md) | [Espanol](README_ES.md) | [Indonesia](README_ID.md) | 🇸🇦 [العربية](README_AR.md)
...
<p align="center">
  ...
  <i>72 strumenti Full / 55 strumenti LITE - Un firmware - Più dispositivi</i>
</p>

---

Una modifica del [Bruce Firmware](https://github.com/pr3y/Bruce) con un modulo **Arsenal** personalizzato. Tutte le funzionalità originali di Bruce rimangono intatte.

## Installazione

1. Scarica il `.bin` da [Releases](../../releases)
2. Flash tramite [ESP Web Flasher](https://espressif.github.io/esptool-js/) (Chrome/Edge) o OTA tramite Arsenal Dashboard

---

## Strumenti Arsenal (72 Full / 55 LITE)

| # | Strumento | Full | LITE | | # | Strumento | Full | LITE |
|---|------|:----:|:----:|-|---|------|:----:|:----:|
...
Arsenal > Dashboard. Connettiti a `ArsenalNet` (password: `arsenal32`). Apri `192.168.4.1`.

## Crediti

- [Bruce Firmware](https://github.com/pr3y/Bruce) di pr3y
