🌐 [English](../README.md) | [Portugues](README_PT.md) | [Italiano](README_IT.md) | [Francais](README_FR.md) | 🇷🇺 [Русский](README_RU.md) | 🇨🇳 [中文](README_ZH.md) | [Polski](README_PL.md) | **Nederlands** | [Turkce](README_TR.md) | [Deutsch](README_DE.md) | Tiếng Việt [Tiếng Việt](README_VN.md) | [Espanol](README_ES.md) | [Indonesia](README_ID.md) | 🇸🇦 [العربية](README_AR.md)
...
<p align="center">
  ...
  <i>72 tools Full / 55 tools LITE - Eén firmware - Meerdere apparaten</i>
</p>

---

Een aangepaste [Bruce Firmware](https://github.com/pr3y/Bruce) met een aangepaste **Arsenal**-module. Alle originele Bruce-functies blijven behouden.

## Installatie

1. Download de `.bin` uit [Releases](../../releases)
2. Flash via [ESP Web Flasher](https://espressif.github.io/esptool-js/) (Chrome/Edge) of OTA via Arsenal Dashboard
...
Arsenal > Dashboard. Verbind met `ArsenalNet` (wachtwoord: `arsenal32`). Open `192.168.4.1`.

## Dank

- [Bruce Firmware](https://github.com/pr3y/Bruce) door pr3y
